...
class Ebux extends React.Component {
  ...
  render() {
    ...
    let isUseWidget =(activeClientProject?.isUseWidget);
    console.log('isUseWidgetisUseWidget',isUseWidget)
    return (
      <>
