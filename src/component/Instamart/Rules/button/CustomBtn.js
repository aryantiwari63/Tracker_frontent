  ...
  return (
    <>
      <div className="row custombtn pl-4">
        <button
          className={["weekbtn ", showdate === "Weekly" && "active instamart_btn"].join(" ")}
          onClick={() => setShowDate("Weekly")}
        >
          Weekly
        </button>
        <button
          className={["weekbtn ", showdate === "Datewise" && "active instamart_btn"].join(" ")}
        ...
        <>
          ...
          {dateTimePerDay.length < 4 && (
            <div className="row pl-4">
              <button
                className="bg-[#0081f7] text-white px-5 h-9 rounded mt-2 hover:bg-black hover:text-white instamart_btn"
