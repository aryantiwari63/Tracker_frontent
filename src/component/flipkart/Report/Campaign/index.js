...
const CampaignReport = () => {
  ...
  const [previousValue, setPreviousValue] = React.useState([...headersData]);
  ...
  const campaignReportDownloadApi = async () => {
    try {
      ...
      const res = await _POST(CAMPAIGN_REPORT_DOWNLOAD_API_URL, downloadFilter,{responseType: "arraybuffer",
