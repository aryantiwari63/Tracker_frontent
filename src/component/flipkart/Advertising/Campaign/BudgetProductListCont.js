...
import IncrementDecrementBtn from "../../../common-components/button/IncrementDecrementBtn";
import KeywordsTargeting from "./keywordtargeting";

const BudgetProductListCont = ({
  setCampaignData,
  campaignData,
  handleChange,
}) => {
...
export default BudgetProductListCont;
