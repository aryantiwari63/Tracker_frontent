...
import KeywordsLeftBlock from "./KeywordsLeftBlock";
import KeywordsRightBlock from "./KeywordsRightBlock";
import { useLocation } from "react-router";

const KeywordsTargetingBlock = ({
  setBroadKeys,
  broadKeys,
  setExactKeys,
  exactKeys,
...
export default KeywordsTargetingBlock;
