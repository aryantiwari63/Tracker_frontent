        ...
        <div className="">
          <div className="">
            <div className="keyword-match-label row">
              Broad Match
              <KeywordTooltip text="Selected Broad match keywords.">
            ...
            <div className="">
              ...
              <div className="">
                <div className="keyword-match-label row mt-1">
                  ...
                  <div className="">
                    {" "}
                    <KeywordTooltip text="Selected Exact match keywords.">
                      <img src="/assets/images/info-blue.svg" alt="" />
                    </KeywordTooltip>
                  </div>
                </div>
...
export default KeywordsRightBlock;
