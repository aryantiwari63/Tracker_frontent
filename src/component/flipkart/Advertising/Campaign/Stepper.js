        ...
        <div className="row stepper__steps ">
          <ol className="row stepper__steps-heading  ">
           <div className=" pr-2">
            ...
            <div className={[" stepper__steps-count",step >=1 && "stepper__steps-count--active"].join(" ")}>1</div>
           ...
           <div className=" pr-2">
            <div className="row items-center">
            <div className={[" stepper__steps-count",step >=2 && "stepper__steps-count--active"].join(" ")}>2</div>
           ...
           <div className=" pr-2">
            <div className="row items-center">
            <div className={[" stepper__steps-count",step ===3 && "stepper__steps-count--active"].join(" ")}>3</div>
