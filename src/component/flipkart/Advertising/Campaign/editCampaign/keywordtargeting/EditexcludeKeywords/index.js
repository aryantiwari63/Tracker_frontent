...
const EditExcludeKeywords = ({ uploadedKeywords, setUploadedKeywords }) => {
          ...
          <div className="upload-keyword ">
            ...
            <div className="product-download-template">
              <span role="presentation" className="link">
                <a
                  // href="https://www.ebuxautomation.com/AMSDashboard/upload/sample/keyword_targeting_exclude.csv"
...
export default EditExcludeKeywords;
