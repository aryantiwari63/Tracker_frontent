...
import { actionActivityHeaders, PERMISSIONS } from "../../../utils/constants";
    ...
    <>
      <div className={"action_table max-h-[500px] overflow-y-scroll rounded"}>
        <table className="w-full">
          ...
          <tr>
             {
              actionActivityHeaders.map((item)=>item.value !== 'account' &&
              (
                  ...
                  return (
                    <tr key={i}>
                      ...
                      {/* <td>
                        ...
                        {data?.account ? (
                          <div className="flex justify-center">
                            {accountIdObject[data?.account]}
                          </div>
                        ) : (
                          <div className="flex justify-center">-jai</div>
                        )}
                      </td> */}
                      <td>
                        {" "}
                        ...
                        {data?.action_type ? (
                              <div className="flex justify-center items-center">
                                <div className="break-all text-center">
                                  {data.action_type.toLowerCase() === "category"
                                    ? data.category_name
                                    : data.action_type.toLowerCase() === "keyword"
                                    ? data.keywords
                                    : data.campaign_name || "-"}
                                </div>
                              </div>
                      ...
                      >
                        ...
                        {data?.action_message ? (
                          <div className="flex justify-center">
                            <div className="line-clamp-2 w-[130px]">
                              {data?.action_message}
                            </div>
                            {data?.action_message?.length > 35 && (
                              <Tooltip
                      ...
                      <td>
                        {/* {data?.status === "True" ? ( */}
                          <div className="flex justify-center items-center gap-3">
                          {
                              ...
                              : <span className="mr-2 text-orange-300">Pending</span>
