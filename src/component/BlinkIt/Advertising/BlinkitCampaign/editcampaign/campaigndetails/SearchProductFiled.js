...
const SearchProductFiled = ({
  ...
  React.useEffect(() => {
    if (campaignData && campaignData?.length && campaignData.products?.length) {
      setSelectedData([...campaignData.products]);
    }
  }, [campaignData]);
    ...
    <>
      <div className="pb-2">
        ...
        <div className="row tooltipblinkit">
          Tip: Please ensure all the products are relevent to the targeting you
          choose in the following steps.
        </div>
      </div>
