...
const OutputConditionBlock = ({ totalConditions, setTotalConditions, entity }) => {
      ...
      <div className="condition__box ">
        <div className="row ">
          {totalConditions?.map((v, i) => {
            return (
              <div key={i} className="  condition-tagblock ">
                {v.greater &&
                ...
                <button className="condition-tagcond ">
                  <button
                    className="w-6 h-6 condtion__tag "
        ...
        return (
          <>
            <div className="row items-stretch  ">
              ...
              <div>
                <select
                  className="form-control  col_6 text-black"
                  onChange={(e) => {
                ...
                >
                  {conditions.map((v) => {
                    return (
                      <>
                        <option className="text-black" value={v.value}>{v.label}</option>
                      </>
                    );
                  })}
                </select>
