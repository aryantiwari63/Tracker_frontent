...
const AmazonPerformanceBreakDownTable = ({
  headers,
  content,
  loading,
  sortData,
                  ...
                  return (
                    <>
                      ...
                      {/* <tr>
                        ...
                        <td className="">{items?.state ? items?.state : "-"}</td>
                        <td>
                          {items?.campaign_type ? items?.campaign_type : "-"}
                        </td>

                        <td>
                          {items.budget !== undefined && items.budget !== null
                            ? currency +
                              parseFloat(items.budget).toLocaleString(currency_format)
                            : "-"}
                        </td>
                        <td>
                          {items.spend !== undefined && items.spend !== null
                            ? currency +
                              parseFloat(items.spend).toLocaleString(currency_format)
                            : "-"}
                        </td>
                        <td>
                        ...
                        <td>
                          {items.units_sold !== undefined &&
                          items.units_sold !== null
                            ? parseFloat(items.units_sold).toLocaleString(
                                currency_format
                              )
                            : "-"}
                        </td>
                        <td>
                          {items.sales !== undefined && items.sales !== null
                            ? currency + items.sales.toLocaleString(currency_format)
                            : "-"}
                        </td>
                        <td>
                          {items.roas !== undefined && items.roas !== null
                            ? `${items.roas.toFixed(1)}`
                            : "-"}
                        </td>
                        <td>
                          {items.cvr !== undefined && items.cvr !== null
                            ? `${Number(items.cvr).toFixed(1)}`
                            : "-"}
                        </td>
                        <td>
                          {items.aov !== undefined && items.aov !== null
                            ? `${items.aov.toFixed(1)}`
                            : "-"}
                        </td>
                        <td>
                          {items.cpc !== undefined && items.cpc !== null
                            ? `${Number(items.cpc).toFixed(1)}`
                            : "-"}
                        </td>
                      </tr> */}
                    </>
...
export default AmazonPerformanceBreakDownTable;
