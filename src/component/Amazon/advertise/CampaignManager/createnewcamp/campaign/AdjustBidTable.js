...
const AdjustBidTable = ({  campaignData, handleChange }) => {
  return (
    <>
      <div>
              ...
              <td className="px-2 py-4">
                <div className="border rounded-md px-2 py-1 bg-white percentageBox">
                  <input
                    ...
                    value={campaignData.PLACEMENT_TOP}
                  />
                  %
                </div>
              </td>
              ...
              <td className="px-2 py-4">
                <div className="border rounded-md px-2 py-1 bg-white percentageBox">
                  <input
                    ...
                    placeholder="Enter number"
                    onChange={handleChange}
                    value={campaignData.PLACEMENT_PRODUCT_PAGE}
                  />
                  %
                </div>
              </td>
              ...
              <td className="px-2 py-4">
                <div className="border rounded-md px-2 py-1 bg-white percentageBox">
                  <input
                    ...
                    placeholder="Enter number"
                    onChange={handleChange}
                    value={campaignData.PLACEMENT_REST_OF_SEARCH}
                  />
                  %
                </div>
              </td>
