...
const AmsCreateCampaignPopup = ({ setOpenState, OpenState }) => {
        ...
        <div className="row">
          <div className="col_4 border-r">
            <CardLayoutCreateCampaign
              ...
              navigateLink="/amazon/advertise/campaignmanager/createnewcamp"
            />
          </div>
...
export default AmsCreateCampaignPopup;
