...
const AmsCreateNewCampaign = () => {
  ...
  const [showAdgroup, setShowAdgroup] = React.useState([]);
      ...
      initialState = data.map((item, i) => {
        return {
          ...
          campaign_id: campaignData[0].campaign_id
            ? campaignData[0].campaign_id
            : null,
          existing_campaign: campaignData[0].existing_campaign
            ? campaignData[0].existing_campaign
            : false,
