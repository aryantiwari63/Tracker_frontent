...
const KeywordTargetingTable = ({checkedItems}) => {
  const { addedProducts, setAddedProducts } = useContext(ManualProductTargetingContext);
  ...
  const producttable = [
    {
      ...
      suggestedbid: { broad: `${currency}50`, exact: `${currency}60`, phrase: `${currency}70` },
    },
    {
      id: 2,
      name: "amazon pay",
    ...
    },
    {
      ...
      value: "amazonreferin",
      matchtype: ["broad", "exact"],
      suggestedbid: { broad: `${currency}50`, exact: `${currency}60` },
    },
    {
      id: 7,
      name: "amazon upis",
    ...
    },
    {
      ...
      matchtype: ["exact"],
      suggestedbid: {exact: `${currency}60` },
    },
    {
      id: 9,
      name: "amazonpaytm",
      value: "amazonpaytm",
      matchtype: ["broad"],
      suggestedbid: { broad: `${currency}50`},
    },
    {
      id: 10,
      name: "amazonphone",
      value: "amazonphone",
      matchtype: ["pharse"],
      suggestedbid: {phrase: `${currency}70` },
    },
  ];
      ...
      <table className="w-full targetTable " >
        <thead className=" bg-gray-100 sticky top-0">
          <tr className="text-sm ">
            <th className="font-normal text-left px-2">{producttable?.length}
              Keyword
              <br />
              IS|IR
              <Tooltip />
              ...
              <tr key={i} className="border-b ">
                ...
                <td>
                  ...
                  <button className="text-blue-400"  onClick={() => {
                    ...
                    {checkedItems.phrase &&<div>
                  <button className="text-blue-400" onClick={() => {
                            addProducts(item,"phrase");
                          }}
                          disabled={addedProducts.some(
                            (ele) => ele.value === item.value && ele.matchtype === "phrase"
                          )}
                          >
                            {addedProducts.some(
                            (ele) => ele.value === item.value && ele.matchtype === "phrase"
                    ...
                    {checkedItems.exact && <div>
                  <button className="text-blue-400" onClick={() => {
                            addProducts(item,"exact");
                          }}
                          disabled={addedProducts.some(
                            (ele) => ele.value === item.value && ele.matchtype === "exact"
                          )}
                          >
                            {addedProducts.some(
                            (ele) => ele.value === item.value && ele.matchtype === "exact"
