...
const AmsBulkCreateAdgroupPopup = ({ setOpenState, OpenState }) => {
  const [showPopup, setShowPopup] = useState(false);

  return (
    <>
      <Popup
        title="Choose your Bulk Adgroup's camapign type"
        ...
        <div className="row">
          <div className="col_4 border-r">
            <CardLayoutBulkCreateCampaign
              ...
              navigateLink="/amazon/advertise/campaignmanager/createadgroupbulkcamp"
            />
          </div>
...
export default AmsBulkCreateAdgroupPopup;
