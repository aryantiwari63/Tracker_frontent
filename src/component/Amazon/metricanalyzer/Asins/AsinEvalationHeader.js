...
const AsinEvalutionHeader = ({
  ...
  const selected = metricsoptions.find(
    (item) => item.value === asinLevelFilter
  )?.label;
  return (
    <div className="row bg-white">
      ...
      <div className="px-4 py-3">
        {/* <select
          ...
          value={asinLevelFilter}
          onChange={(e) => setAsinLevelFilter(e.target.value)}
        >
...
export default AsinEvalutionHeader;
