...
import { metricAnalyzerAvgKeyword } from "../../../../services/dashboard";
import CustomSelectNew from "../../../common-components/CustomSelectNew";

const KeywordEvalationHeader = ({
  platform,
  dateRange,
  campType,
  compareValue,
  ...
  const initLoad = async () => {
    ...
    const res = await metricAnalyzerAvgKeyword(payload);
...
export default KeywordEvalationHeader;
