                ...
                return (
                  <>
                    <tr>
                      ...
                      <td className="pr-4 px-3">{item.campaign_name}</td>
                      <td className="pr-4 px-3">{item.portfolio}</td>
                      <td className="pr-4 px-3">{item.ad_group}</td>
                      <td className="pr-4 px-3">{item.status}</td>
                      <td className="pr-4">{item.sku}</td>
                      <td className="pr-4 px-3">{item.asin}</td>
                      ...
                      <td className="pr-4 px-3">{item.ads}</td>
                      ...
                      <td className="pr-4 px-3">{item.ntb_sales}</td>
                  ...
                  {footer?.map((item) => {
                    return (
                      <>
                        ...
                        <td className="pr-4 font-semibold">{item.portfolio}</td>
                        <td className="pr-4 font-semibold">{item.ad_group}</td>
                        <td className="pr-4 font-semibold">{item.status}</td>
                        <td className="pr-4 font-semibold">{item.sku}</td>
                        <td className="pr-4 font-semibold">{item.asin}</td>
                        <td className="pr-4 font-semibold">
                          {item.impressions}
                        </td>
                        ...
                        <td className="pr-4 font-semibold">{item.ads}</td>
                        <td className="pr-4 font-semibold">
                          {item.units_sold}
                        </td>
                        <td className="pr-4 font-semibold">
                        ...
                        <td className="pr-4 font-semibold">
                          {item.percent_orders_ntb}
                        </td>
                        <td className="pr-4 font-semibold">{item.ntb_sales}</td>
                        <td className="pr-4 font-semibold">
                          {item.percent_sales_ntb}
                        </td>
                      </>
                    );
                  })}
...
export default AmsCreativeTable;
