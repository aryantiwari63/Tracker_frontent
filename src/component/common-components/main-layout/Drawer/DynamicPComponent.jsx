...
function DynamicPFilterComponent({ expanded, handleToggle, handleSelectAll, handleCheck, searchTerm }) {
    const {
        filters,
    ...
    const handleApplyClick = async () => {
        ...
        if (typeof handleCheck === "function") {
            const allDynamicP = Array.isArray(filters?.dynamicPData) ? filters.dynamicPData : [];
    ...
    const sortedDynamicP = useMemo(() => {
        const list = Array.isArray(filters?.dynamicPData) ? filters.dynamicPData : [];
        ...
        return sortedList;
    }, [filters?.dynamicPData, searchTerm, dynamicPSearch, localSelectedDynamicP]);
...
export default DynamicPFilterComponent;