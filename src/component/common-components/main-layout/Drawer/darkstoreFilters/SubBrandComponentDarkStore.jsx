...
function SubBrandFilterComponentDarkStore({ expanded, handleToggle, handleSelectAll, handleCheck, searchTerm }) {
    const {
        filtersDarkStore,
    ...
    const handleApplyClick = async () => {
        ...
        if (typeof handleCheck === "function") {
            const allSubBrand = Array.isArray(filtersDarkStore?.subBrandData) ? filtersDarkStore.subBrandData : [];
    ...
    const sortedSubBrand = useMemo(() => {
        const list = Array.isArray(filtersDarkStore?.subBrandData) ? filtersDarkStore.subBrandData : [];
        ...
        return sortedList;
    }, [filtersDarkStore?.subBrandData, searchTerm, subBrandSearch, localSelectedSubBrand]);
...
export default SubBrandFilterComponentDarkStore;