...
function SegmentFilterComponent({ expanded, handleToggle, handleSelectAll, handleCheck, searchTerm }) {
    const {
        filters,
    ...
    const handleApplyClick = async () => {
        ...
        if (typeof handleCheck === "function") {
            const allSegments = Array.isArray(filters?.segmentData) ? filters.segmentData : [];
    ...
    const sortedSegments = useMemo(() => {
        const list = Array.isArray(filters?.segmentData) ? filters.segmentData : [];
        ...
        return sortedList;
    }, [filters?.segmentData, searchTerm, segmentSearch, localSelectedSegments]);
...
export default SegmentFilterComponent;