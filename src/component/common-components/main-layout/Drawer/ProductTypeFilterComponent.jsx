...
function ProductTypeFilterComponent({ expanded, handleToggle, handleSelectAll, handleCheck, searchTerm }) {
    const {
        filters,
    ...
    const handleApplyClick = async () => {
        ...
        if (typeof handleCheck === "function") {
            const allProductTypes = Array.isArray(filters?.productTypeData) ? filters.productTypeData : [];
    ...
    const sortedProductTypes = useMemo(() => {
        const list = Array.isArray(filters?.productTypeData) ? filters.productTypeData : [];
        ...
        return sortedList;
    }, [filters?.productTypeData, searchTerm, productTypeSearch, localSelectedProductTypes]);
...
export default ProductTypeFilterComponent;