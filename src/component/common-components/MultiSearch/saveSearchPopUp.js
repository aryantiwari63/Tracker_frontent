...
export default function SaveSearchPopUp({
  ...
  console.log(platform,buttonThemeObj[platform])
      ...
      >
        <div className="relative my-6 mx-auto max-w-2xl">
          ...
          >
            {/*header*/}
            <div
              className="flex items-start justify-between px-4 pt-2 border-b border-solid 
            ...
            <div className="flex items-center justify-end p-2  border-solid border-slate-200 rounded-b">
              ...
              <button
                ...
                className={[
                  ...
                  // platform === "ams" && "bg-[#FF9901] active:bg-[#FF9901]",
