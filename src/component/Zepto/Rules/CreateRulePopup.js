...
const accountArr=[
  ...
  {
    label:"Awareness+Performance",
    value:"Awareness,Performance"
  }
]
...
const CreateRulePopup = ({ setOpenState, getRulesApi = _.noop }) => {
  ...
  useEffect(() => {
    switch (entity) {
      case "Campaign":
        if (campaignType.includes("Awareness") && campaignType.includes("Performance")) {
  ...
  const fetchAllTagsApi = async () => {
    try {
      setLoading(true);
      const response = await _GET(`${GET_ALL_TAGS}?platform=${"zepto"}&data_level=campaign`);
      setLoading(false);
      ...
      >
        <div className="pl-4 pr-3 pb-4">
          ...
          <div className=" flex pt-2 gap-2">
            <div className="text-[13px] flex-[0.5]">
              ...
              <input
                type="text"
                className="w-full border h-[32px] pl-2 rounded-md border-gray-300 zeptoRing "
                name="rule_name"
                id="rule_name"
            ...
            />
              ...
              {/* <select
                name="campaign_type"
                id="campaign_type"
                className="w-full border h-[32px] pl-2 rounded border-gray-300 zeptoRing"
                value={entity}
                onChange={(e) => {
                  setActionRuleError(false);
              ...
              >
                ...
                <option className="text-[13px]" value="Product">
                Product
                </option>
          ...
          <div className=" row mt-1">
            <div className="flex-[0.5] text-[13px]">
              <label className="" htmlFor="">
                Account
              </label>
              <label className="text-red-500">*</label>
              ...
              <MultiSelect
                className={`h-[31px] z-100 rmsc--zepto rounded-md`}
            ...
            />
              {/* <select
                ...
                onChange={(e) => {
                  ...
                  if (selectedValues.includes("Awareness,Performance")) {
                    setCampaignType(["Awareness", "Performance"]);
                  } else {
                    setCampaignType(selectedValues);
                  }
                  
                }}
                className="border w-full h-[32px] rounded pr-4 border-gray-300 zeptoRing"
              >  
                <option value="Awareness">Awareness</option>
                <option value="Performance">Performance</option>
                <option value="Awareness,Performance">Awareness+Performance</option>
              </select> */}
            </div>

            <div className=" w-1/2 pl-2 z-10">
              <label className="text-[13px] " htmlFor="">
                Tags{" "}
              </label>
              <MultiSelect
                disabled={!showTags}
                className={`${!showTags ? "disableMulti" : ""}  h-[31px] rmsc--zepto`}
                options={options()}
                value={selectedTags}
              ...
              <div className="flex w-full ">
                ...
                <select
                  ...
                  className={
                    selectedAction !== "IncreaseBudget" &&
                      selectedAction != "IncreaseBid"
                      ? "border w-1/2 h-[32px] rounded pr-4 border-gray-300 zeptoRing  mr-1"
          ...
          <div className=" flex mt-1">
            <div className=" w-1/2 pl-1">
              ...
              className={`condition__plus-btn zepto_btn ${validEmail[index] == false ?"cursor-not-allowed" : "" } bg-slate-500 h-[36px] ml-3`
        ...
        >
          <TimeRange timeRange={handleTimeRange} platform="zepto"/>
        </div>
