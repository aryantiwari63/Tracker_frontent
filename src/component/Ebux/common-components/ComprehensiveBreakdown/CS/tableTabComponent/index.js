...
const TableTabComponent = ({
    ...
    const headerkey = { "total_score": "Total Score", "title_score": "Title Score", "desc_score": "Desc Score", "bulletin_score": "Bulletin Score", "image_score": "Image Score", "products_count_by_group": "A+" };
    ...
    const handleDownload = () => {
        ...
        const title = `${dataHeader} Content Score Report`;
