 ...
 */
export default function CalendarPopup({dates=[], open, dateRange, anchor, title, onClose }) {
    if (!open) return null;
    ...
    return (
        <div style={popupStyle} ref={popupRef}>
            ...
            <div className='m-2 p-4 border rounded-lg shadow-sm'><DateRangeCalender selectedDate={dates?.map(i=>new Date(i))}/> </div>
        </div>
    );
}
