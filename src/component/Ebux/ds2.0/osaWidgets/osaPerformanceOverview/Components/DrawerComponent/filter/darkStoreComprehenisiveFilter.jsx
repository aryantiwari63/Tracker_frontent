...
const DarkstoreComprehensiveFilter = ({
    arr = [],
    openMFilter = null,
    setOpenMFilter,
    additionalFilter = [],
    ...
    return (
        <MultiFilter openMFilter={openMFilter} setOpenMFilter={setOpenMFilter} filterData={filterData} applySearchFilter={applySearchFilter} handleSaveFilters={handleSaveFilters} savedSearch={savedSearch} defaultValue={defaultValue} platform={platform} isSearchable={true} isChipVIsible={true} showSearchBar={false} hasCancel={false} />
    );
}

export default DarkstoreComprehensiveFilter
