...
function ToggleWidget() {
  ...
  try {
    ...
    setDropped([...savedMapped, ...availableMapped]);
  ...
  return (
    <div>
      ...
      {isOpen && (
        ...
        >
          <div className="flex items-center justify-center mx-auto my-[2.75rem] w-[70%]">
            <div className="relative flex flex-col w-full background-clip-padding">
              <div className="h-fit  border-[1.51px] border-[#E5E5E5] rounded-[4px]">
                ...
                <div className="bg-transparent">
                  ...
                  <DragAndDrop dropped={dropped} setDropped={setDropped} savedData={savedData} />
                </div>
                {/* </div> */}
                {/* Footer */}
