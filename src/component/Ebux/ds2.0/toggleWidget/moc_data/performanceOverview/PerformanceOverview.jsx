...
function MockPerformanceOverview() {
  const Country = "India";
  ...
  const [locationSteps, setLocationSteps] = useState({ "Country": Country, "Region": null, "State": null, "City": null });
  ...
  useEffect(() => {
    ...
    // if (!filtersLoading && !isEqual(previousSelectedFilters.current, JSON.stringify({ ...selectedFilters,locationSteps }))) {
    //       previousSelectedFilters.current = JSON.stringify({ ...selectedFilters,locationSteps });
    //       fetchData();
    //     }
    fetchData();
  }, [locationSteps]);
  ...
  return (
    <div className="">
      <div>
        ...
        {/* Graphical Analysis */}
        <div className="mt-3 bg-blue-50 py-4 px-3 rounded-md border border-blue-300">
          <div className="bg-white px-1 py-0.5 rounded-sm">
            <div className="flex gap-[4px] items-center">
              <h5 className="text-[8px] font-semibold text-gray-700 leading-none">
                OSA Performance Overview:
              </h5>
              <span className="inline-flex gap-[2px] items-center bg-blue-50 border border-blue-200 text-blue-600 px-1 py-[1px] rounded-sm font-medium text-[8px] leading-none">
                <img
                  src="/assets/images/widget/meggi.png"
          ...
          <div className="mt-3 flex flex-wrap flex-[0_0_auto] -mx-[9px]">
            <div className="w-1/2 flex-[0_0_auto] px-[8px] mb-4">
              <GraphicalAnalysis />
              <div className="table-container">
                <PerformanceTableGraphical />
              </div>
            </div>
            <div className="w-1/2 flex-[0_0_auto] px-[6px]">
              <div className="bg-white shadow-md rounded-xl flex flex-col">
                {/* Header */}
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-1 px-2 pt-2">
                  <div>
                    <h2 className="text-[10px] font-semibold text-gray-800 leading-tight">
                      Region-wise OSA Performance
                    </h2>
                    <p className="text-[7px] text-gray-500 leading-none">Region</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-1 px-2">
                  ...
                  <div className="flex gap-1 text-[10px] font-medium">
                    {[
                      ...
                      .map((step, index, arr) => (
                        <span key={step.key} className="flex items-center gap-[1px]">
                          <button className="text-blue-600 hover:underline focus:outline-none text-[9px] px-[1px] py-[0.5px] leading-none">
                            {step.label}
                          </button>
                          {index < arr.length - 1 && (
...
export default MockPerformanceOverview;